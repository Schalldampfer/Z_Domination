...
private _specus = [_poss, ["zombie", d_enemy_side_short] call d_fnc_getunitlistm, _newgroup, true, true] call d_fnc_makemgroup;\
sleep 1.0112;\
...
if (d_mt_respawngroups == 0) then { \
	...
	_newgroup setVariable ["d_respawninfo", ["zombie", [], _trg_center, 0, "patrol2", d_side_enemy, 0, 0, 1, [_trg_center, _mtradius], false, []]]; \
};
...
private _sec_kind = 4;//(floor (random 10)) + 1;
