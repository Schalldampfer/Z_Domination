...
d_main_tower = "Land_MedicalTent_01_greenhex_closed_F";
d_illum_tower = "Land_TTowerBig_2_F";
d_wcamp = "Land_DeconTent_01_CSAT_greenhex_F";
...
#include "d_allmen_O_uns.sqf"
	...
	d_zombie_E = [
#include "d_zombie_O_zombie.sqf"
	];
	d_demon_E = [
#include "d_demon_O_zombie.sqf"
	];
	d_bandit_E = [
#include "d_bandit_O_default.sqf"
	];
...
#include "d_specops_O_uns.sqf"
	...
	if (d_tanoa || {d_livonia}) then {
		...
		d_sniper_E = [["O_G_Soldier_M_F","O_G_Sharpshooter_F"]];
		d_sniper_W = [["B_G_Soldier_M_F","B_G_Sharpshooter_F"]];
		d_sniper_G = [["I_L_Hunter_F","I_L_Looter_Rifle_F"]];
	};
	
#ifdef __RHS__
	d_specops_E = [
		["rhsgref_tla_rifleman_l1a1","rhsgref_tla_rifleman_M16","rhsgref_ins_medic","rhsgref_ins_saboteur","rhsgref_ins_machinegunner","rhsgref_tla_machinegunner_mg42","rhsgref_tla_rifleman_rpg75","rhsgref_ins_rifleman_RPG26"]
	];
#endif
...
#endif
#ifdef __RHS__
	d_sabotage_E = [["rhsgref_ins_saboteur", "rhsgref_ins_engineer"]];
...
#endif
#ifdef __RHS__
	d_sniper_E = [["rhsgref_ins_militiaman_mosin","rhsgref_ins_sniper","rhsgref_tla_rifleman_m1"]];
...
#include "d_sm_classes_uns.sqf"
	...
	d_enemy_hq = switch (d_enemy_side_short) do {
		case "E": {"Land_DeconTent_01_NATO_tropic_F"};
		case "W": {"Land_DeconTent_01_CSAT_greenhex_F"};
	...
	d_barracks_building = "Land_MedicalTent_01_CSAT_greenhex_generic_open_F";
	...
	d_vehicle_building = "Land_MedicalTent_01_CSAT_greenhex_generic_closed_F";
	...
	_civVehiclesWeightedCityWealthHigh = [
		"B_GEN_Offroad_01_gen_F", 0.10,
		"B_GEN_Van_02_vehicle_F", 0.10,
		"C_Van_02_medevac_F", 0.05,
		"C_Offroad_01_F", 0.05,
		"C_Hatchback_01_F", 0.20,
		"C_Truck_02_covered_F", 0.05, 
		"C_Van_01_box_F", 0.05,
		"C_Van_02_transport_F", 0.05,
		"C_Hatchback_01_sport_F", 0.10,
		"C_Offroad_02_unarmed_F", 0.10,
		"C_SUV_01_F", 0.15
	];
	
	_civVehiclesWeightedCityWealthLow = [
		"B_GEN_Offroad_01_gen_F", 0.10,
		"B_GEN_Van_02_vehicle_F", 0.05,
		"C_Van_02_medevac_F", 0.05,
		"C_Offroad_01_F", 0.10,
		...
		"C_Hatchback_01_F", 0.15,
		"C_SUV_01_F", 0.16
	];
	
	_civVehiclesWeightedRural = [
		"B_GEN_Offroad_01_gen_F", 0.05,
		"C_Offroad_01_F", 0.25,
...
if (hasInterface) then {
	...
	"RHS_UH60M_ESSS2","rhsusf_M1117_W","uns_M113_transport","uns_UH1H_m60"];
#endif
#ifdef __OWN_SIDE_OPFOR__
	call {
		if (d_ifa3lite) exitWith {
