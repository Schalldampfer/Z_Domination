...
private _type_list_guard = [
	["zombie", 0, [d_footunits_guard, 0] call _selectitmen],
	["zombie", 0, [d_footunits_guard, 1] call _selectitmen]
];

private _type_list_guard_static = [
	["zombie", 0, [d_footunits_guard_static, 0] call _selectitmen],
	["zombie", 0, [d_footunits_guard_static, 1] call _selectitmen]
];
